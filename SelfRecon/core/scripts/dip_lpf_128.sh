...
function dip_denoising()
{
    ...
    echo "DIP --upsample_mode $upsample_mode --special $results_save_folder --folder_path $image_folder --reg_noise_std $reg_noise_std  --exp_weight $exp_weight"
    
    python denoising.py --task denoising \
                      --folder_path $image_folder\
                      --save_folder '/mnt/yaplab/data/yilinliu/saves/LPF/128chns' \
                      --model_type DIP_LPF \
                      --imsize 512 512 \
                      --progressive False \
                      --num_iters 3000 \
...
#dip_denoising LPF1 "/mnt/yaplab/data/yilinliu/datasets/ours_texture_dataset/Texture_Datasets_NoRepeat/128_2" '1/30'  0.99

#ConvDecoder Upsampler:LPF2 NoisePertubation:0  ExpWeight:0.99
#dip_denoising LPF2 "/mnt/yaplab/data/yilinliu/datasets/ours_texture_dataset/Texture_Datasets_NoRepeat/128_2" '1/30'  0.99

#ConvDecoder Upsampler:LPF3 NoisePertubation:0  ExpWeight:0.99
#dip_denoising LPF3 "/mnt/yaplab/data/yilinliu/datasets/ours_texture_dataset/Texture_Datasets_NoRepeat/128_2" '1/30'  0.99

#ConvDecoder Upsampler:LPF4 NoisePertubation:0  ExpWeight:0.99
#dip_denoising LPF4 "../data/denoising2" 0  0.99

#ConvDecoder Upsampler:LPF41 NoisePertubation:0  ExpWeight:0.99
#dip_denoising LPF41 "../data/denoising2" 0  0.99

#ConvDecoder Upsampler:LPF5 NoisePertubation:0  ExpWeight:0.99
dip_denoising LPF5 "/mnt/yaplab/data/yilinliu/datasets/ours_texture_dataset/Texture_Datasets_NoRepeat/128_2" '1/30'  0.99

#ConvDecoder Upsampler:LPF6 NoisePertubation:0  ExpWeight:0.99
dip_denoising LPF6 "/mnt/yaplab/data/yilinliu/datasets/ours_texture_dataset/Texture_Datasets_NoRepeat/128_2" '1/30'  0.99
