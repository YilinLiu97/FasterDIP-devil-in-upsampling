...
function conv_dec_denoising() 
{
    ...
    python denoising.py --task denoising \
                      ...
                      --save_folder '/mnt/yaplab/data/yilinliu/saves/LPF/Fig3' \
...
#conv_dec_denoising bilinear "../data/denoising1/" 0  0.99
conv_dec_denoising LPF15 "../data/denoising1/" 0  0.99
conv_dec_denoising LPF14 "../data/denoising1/" 0  0.99
